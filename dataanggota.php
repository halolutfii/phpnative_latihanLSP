                    ...
                    <div class="row">
                        <div class="col-12 col-xl-12 mb-4 mb-lg-0">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="addanggota.php" class="btn btn-sm btn-success">Tambah</a>
                                        ...
                                        <table class="table">
                                            ...
                                            if($res->num_rows > 0){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="updateanggota.php?id=<?php echo $row["idanggota"];?>" class="btn btn-sm btn-outline-primary">Edit</a>
                                                        <a href="deleteanggota.php?id=<?php echo $row["idanggota"];?>" class="btn btn-sm btn-outline-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                               <?php
                                               $no++;
