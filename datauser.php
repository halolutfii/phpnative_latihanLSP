                    ...
                    <div class="row">
                        <div class="col-12 col-xl-12 mb-4 mb-lg-0">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="adduser.php" class="btn btn-sm btn-success">Tambah</a>
                                        ...
                                        <table class="table">
                                            ...
                                            if($res->num_rows > 0){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="updateuser.php?id=<?php echo $row["iduser"];?>" class="btn btn-sm btn-outline-primary">Edit</a>
                                                        <a href="deleteuser.php?id=<?php echo $row["iduser"];?>" class="btn btn-sm btn-outline-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                               <?php
                                               $no++;
